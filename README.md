...
- A API a ser criada deverá acessar o banco de dados a ser criado `pdv` para persistir e manipular os dados de categorias, clientes, pedidos, status e usuários utilizados pela aplicação.
...
<details>
<summary><b>Cadastrar Status</b></summary>

#### `POST` `/status`

Essa é a rota que permite o usuário logado cadastrar um novo status no sistema.
...
Critérios de aceite:
    ...
    -   Validar os campos obrigatórios:
        ...
        -   valor
        -   categoria_id
    -   A categoria informada na qual o status será vinculado deverá existir.

</details>

<details>
<summary><b>Editar dados do status</b></summary>

#### `PUT` `/status/:id`

Essa é a rota que permite o usuário logado a atualizar as informações de um status cadastrado.

Critérios de aceite:

    -   Validar se existe status para o id enviado como parâmetro na rota.
    -   Validar os campos obrigatórios:
        -   descricao
        -   quantidade_estoque
        -   valor
...
<details>
<summary><b>Listar Statuss</b></summary>

#### `GET` `/status`

Essa é a rota que será chamada quando o usuário logado quiser listar todos os status cadastrados.

Deveremos incluir um parâmetro do tipo query **categoria_id** para que seja possível consultar status por categorias, de modo, que serão filtrados de acordo com o id de uma categoria.

Critérios de aceite:

    - Caso seja enviado o parâmetro do tipo query **categoria_id**, filtrar os status de acordo com a categoria, caso o id de categoria informada exista.
    - Caso não seja informado o parâmetro do tipo query **categoria_id** todos os status cadastrados deverão ser retornados.

</details>

<details>
<summary><b>Detalhar Status</b></summary>

#### `GET` `/status/:id`

Essa é a rota que permite o usuário logado obter um de seus status cadastrados.
...
<details>
<summary><b>Excluir Status por ID</b></summary>

#### `DELETE` `/status/:id`

Essa é a rota que será chamada quando o usuário logado quiser excluir um de seus status cadastrados.
